...
$cloneParams = @{
    ...
    SourceVMName             = "Test012GoldenImageUpdateBeforeCloning"
    DestinationVMDescription = "Win1022H2Template_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
    ExportPath               = "C:\VM\ExportedVMs"
    ImportPath               = "C:\VM\ImportedVMs"
}
