...
# https://lab-hv01/servermanager/connections/server/lab-hv01/tools/virtualmachines/inventory
...
Export-Connection "https://lab-hv01" -fileName "WAC-connections.csv"
# Import connections (including tags) from a .csv file
Import-Connection "https://lab-hv01" -fileName "WAC-connections.csv"
...
Import-Connection "https://lab-hv01" -fileName "WAC-connections.csv" -prune
...
# # Get the Windows Admin Center endpoint
# $GatewayEndpoint = [Uri] "https://localhost:6516"

# # Retrieve all connections managed by Windows Admin Center
# $connections = Get-Connections -GatewayEndpoint $GatewayEndpoint

# # Iterate through each connection and gather its name, host name, and IP address
# foreach ($connection in $connections) {
#     if ($connection.Type -eq 'msft.sme.connection-type.server') {
#         $vmName = $connection.Name
#         $vmHostName = $connection.Name
