...
function Capture-CustomImage {
    ...
    try {
        ...
        #calling C:\Program Files (x86)\Windows Kits\10\Assessment and Deployment Kit\Deployment Tools\amd64\DISM\dism.exe instead of C:\Windows\System32\dism.exe because it's newer
...
$params = @{
    ImageFile  = "D:\VM\Setup\WIM\install2.wim"
    CaptureDir = "H:\"
    ImageName  = "Windows 11 Custom Image"
}
