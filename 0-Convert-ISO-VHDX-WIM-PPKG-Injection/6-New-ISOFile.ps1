...
# Define paths for PPKG and ISO
$ppkgPath = "D:\VM\Setup\PPKG\RunPSOOBEv3.ppkg"
$isoOutputPath = "D:\VM\Setup\ISO\RunPSOOBEv3.iso"

# Call New-IsoFile to create the ISO with the PPKG
New-IsoFile -Source $ppkgPath -Path $isoOutputPath -Force
