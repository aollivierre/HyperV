...
# [string]$VMNamePrefix = "037 - OSX-Sonoma14"
[string]$VMNamePrefix = "071 - Ubuntu - Docker - Syncthing"
[string]$SwitchName = "Realtek Gaming 2.5GbE Family Controller - Virtual Switch"
# [string]$InstallMediaPath = "D:\VM\Setup\ISO\proxmox-ve_8.1-1.iso"
# [string]$InstallMediaPath = "D:\VM\Setup\ISO\ubuntu-24.04-live-server-amd64.iso"
# [string]$InstallMediaPath = "D:\VM\Setup\ISO\OpenCore-v21.iso"
# [string]$InstallMediaPath = "D:\VM\Setup\ISO\Windows_10_22H2_July_29_2023.iso"
[string]$InstallMediaPath = "D:\VM\Setup\ISO\Windows_SERVER_2022_EVAL_x64FRE_en-us-May-17-2024.iso"
